...
export class MpiIdWidget extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <NumberWidget
        title="MPIIDs"
        fullPageLink="/dashboard/HIE.Management.MpiidsDetail"
        loading={loading}
        error={error}
        series={[
          {
            aggregate: {
              ...
              label: `MPIIDs in the last ${differenceInMonths(endDate, startDate) + 1} months`
            },
...
const withQuery = graphql(query, {
  ...
  props: ({ data /*, ownProps*/ }) => {
    ...
    return { loading, error, data: hie && hie.mpiids && hie.mpiids.byMonth };
  }
});

export default withMonthRange()(withQuery(MpiIdWidget));
