...
export class RegisteredDocumentsWidget extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <NumberWidget
        ...
        fullPageLink="/dashboard/HIE.Management.RegisteredDocumentsDetail"
        loading={loading}
        error={error}
        series={[
          {
            aggregate: {
              ...
              label: `Registered Documents in the last ${differenceInMonths(endDate, startDate) + 1} months`
            },
...
const withQuery = graphql(query, {
  ...
  props: ({ data /*, ownProps*/ }) => {
    ...
    return { loading, error, data: hie && hie.documents && hie.documents.count };
  }
});

export default withMonthRange()(withQuery(RegisteredDocumentsWidget));
