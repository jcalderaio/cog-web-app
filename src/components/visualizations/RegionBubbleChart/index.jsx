...
export class RegionBubbleChart extends Component {
/*eslint-enable */
  ...
  render() {
    ...
    return (
      <div className={'widget-chart region-bubble-chart-widget unselectable'}>
...
RegionBubbleChart.defaultProps = {
  showLegend: false,
  showGraticule: false,
  meshClass: 'border',
  polygonClass: 'land',
