// fork of https://github.com/Reggino/react-svg-gauge
	...
	render() {
		...
		return (
				<svg height="100%" version="1.1" width="100%" xmlns="http://www.w3.org/2000/svg" style={{width: this.props.width, height: this.props.height, overflow: 'hidden', position: 'relative', left: 0, top: 0}}>
					...
					>
						{ Number.isInteger(this.props.value) ? this.props.value : 'N/A' }
					</text>
					<text x={((Cx - Ro) + (Cx - Ri)) / 2} y={Cy + 15} 
						textAnchor="middle" style={this.props.minMaxLabelStyle}>
						{this.props.min}
					</text>
					<text x={(Xo + Xi)/2} y={Cy + 15} textAnchor="middle" style={this.props.minMaxLabelStyle}>
						{this.props.max}
					</text>
				</svg>
		);
