...
import { MrnsDetailFilters } from "./filters";

describe("MrnsDetailFilters", () => {
  ...
  const wrapper = shallow(<MrnsDetailFilters filters={{}} updateFilters={mockUpdateFilters} data={data} />);
