...
export class View extends Component {
  ...
  get columns() {
    return [{ Header: 'Organization', accessor: 'organization' }, { Header: 'Search Count', accessor: 'count' }];
  }
...
export default graphql(query, {
  ...
  props: ({ ownProps, data }) => {
    ...
    const records = (hie && hie.searches && hie.searches.detailsByDate) || [];
